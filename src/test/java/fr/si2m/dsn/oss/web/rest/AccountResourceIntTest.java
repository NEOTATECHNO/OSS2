package fr.si2m.dsn.oss.web.rest;

import fr.si2m.dsn.oss.Oss2App;
import fr.si2m.dsn.oss.domain.Authority;
import fr.si2m.dsn.oss.domain.PersistentToken;
import fr.si2m.dsn.oss.domain.User;
import fr.si2m.dsn.oss.repository.AuthorityRepository;
import fr.si2m.dsn.oss.repository.PersistentTokenRepository;
import fr.si2m.dsn.oss.repository.UserRepository;
import fr.si2m.dsn.oss.security.AuthoritiesConstants;
import fr.si2m.dsn.oss.service.MailService;
import fr.si2m.dsn.oss.service.UserService;
import fr.si2m.dsn.oss.service.dto.UserDTO;
import fr.si2m.dsn.oss.web.rest.vm.KeyAndPasswordVM;
import fr.si2m.dsn.oss.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = Oss2App.class)
